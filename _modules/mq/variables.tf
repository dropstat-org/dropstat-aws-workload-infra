...
variable "engine_version"            { type = string; default = "5.17.6" }
variable "publicly_accessible"       { type = bool;   default = false }
variable "admin_username"            { type = string; default = "dropstat" }
variable "admin_password"            {
  type      = string
  sensitive = true
  # Must be provided — store in Secrets Manager, not here
}
